...
export default {
  ...
  children: (pre => [
    ...
    { path: 'amap', name: `${pre}amap`, component: _import('demo/plugins/amap'), meta: { ...meta, title: '高德地图' } },
    { path: 'amap2', name: `${pre}amap2`, component: _import('demo/plugins/amap2'), meta: { ...meta, title: '高德地图' } }
  ])('demo-plugins-')
}
