...
Vue.component('admin-drop-column', () => import('./admin-drop-column'))
Vue.component('admin-single-upload', () => import('./admin-single-upload'))
Vue.component('admin-status-tag', () => import('./admin-status-tag'))
Vue.component('admin-date-range', () => import('./admin-date-range'))
