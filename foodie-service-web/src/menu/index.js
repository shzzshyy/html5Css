...
if (process.env.NODE_ENV === 'development') {
  ...
  menuTemp.push(demoPlayground)
  menuTemp.push(demoBusiness)
  menuTemp.push(Generate)
}

// 菜单 侧边栏，可以显示在左侧的一块，数组的一个元素可以一起展示在左侧
...
export const menuInit = supplementPath(menuTemp)
